...
class WC_Booking_Form_Date_Picker extends WC_Booking_Form_Picker {
	...
	protected function find_fully_booked_blocks() {
		...
		foreach ( $existing_bookings as $existing_booking ) {
			...
			$start_date = apply_filters('woocommerce_get_bookings_in_range_start', $start_date, $this->booking_form->product);
			$end_date = apply_filters('woocommerce_get_bookings_in_range_end', $end_date, $this->booking_form->product);
			$end_date = strtotime('tomorrow midnight', $end_date);
