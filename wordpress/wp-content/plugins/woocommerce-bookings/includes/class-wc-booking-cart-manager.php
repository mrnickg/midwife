...
class WC_Booking_Cart_Manager {
	...
	public function add_cart_item_data( $cart_item_meta, $product_id ) {
		...
		$postData = apply_filters('woocommerce_booking_get_posted_data', $_POST, $product);

		$booking_form                       = new WC_Booking_Form( $product );
		$cart_item_meta['booking']          = $booking_form->get_posted_data( $postData );
		$cart_item_meta['booking']['_cost'] = $booking_form->calculate_booking_cost( $postData );
