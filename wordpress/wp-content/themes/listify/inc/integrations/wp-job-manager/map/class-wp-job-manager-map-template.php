...
class Listify_WP_Job_Manager_Map_Template extends listify_Integration {
	...
	public function setup_actions() {
		...
		if ( ! ( get_option( 'job_manager_regions_filter' ) && listify_has_integration( 'wp-job-manager-regions' ) ) ) {
	...
	public function enqueue_scripts( $force = false ) {
		...
		$settings = array(
			...
			'mapOptions' => array(
                ...
                'scrollwheel' => listify_theme_mod( 'map-behavior-scrollwheel' ) == 'on' ? true : false
			),
			'searchRadius' => array(
