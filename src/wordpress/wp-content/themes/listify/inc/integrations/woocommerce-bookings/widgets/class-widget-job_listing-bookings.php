...
class Listify_Widget_Listing_Bookings extends Listify_Widget {
	...
	public function __construct() {
		...
		if ( is_active_widget( false, false, $this->widget_id, true ) ) {
			...
			add_action( 'listify_widget_job_listing_bookings', array( $this, 'output_bookings'), 10, 1);
		}
	}
	...
	function widget( $args, $instance ) {
		...
		do_action( 'listify_widget_job_listing_bookings', $products );
	...
	function output_bookings( $products ) {
		global $product;
