...
class FacetWP_Facet_Dropdown
{
	...
	function load_values( $params ) {
		...
		$select_clause = 'f.facet_value, f.facet_display_value, f.term_id, f.parent_id, f.depth, COUNT(*) AS counter';
		...
		$select_clause = apply_filters( 'facetwp_facet_select', $select_clause, $facet);
	...
	function render( $params ) {
		...
		foreach ( $values as $result ) {
			...
			$display_value .= $this->translated_display($result);
	...
	function translated_display($result) {
		...
		return $result['facet_display_value'];
	}
}
