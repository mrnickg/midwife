...
Description: Adds premium functionality to MailChimp for WordPress.
Version: 3.0.6
Author: ibericode
...
define( 'MC4WP_PREMIUM_VERSION', '3.0.6' );
...
function __mc4wp_premium_load() {
	...
	// make sure core plugin is installed and at version 3.0
