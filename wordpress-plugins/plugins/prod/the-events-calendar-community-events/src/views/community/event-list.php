				...
				while ( $events->have_posts() ) {
					...
					<tr>
						...
						<td>
							...
							echo tribe_event_format_date( $start_date, false, Tribe__Events__Community__Main::instance()->eventListDateFormat );
							?>
						</td>
						...
						<td>
							...
							echo tribe_event_format_date( $end_date, false, Tribe__Events__Community__Main::instance()->eventListDateFormat );
							?>
						</td>
