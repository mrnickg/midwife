...
class Tribe__Events__Community__Event_Form {
	...
	protected function setup_hooks() {
		...
		if ( class_exists( 'Tribe__Events__Pro__Main' ) ) {
			remove_action( 'tribe_events_date_display', array( 'Tribe__Events__Pro__Recurrence_Meta', 'loadRecurrenceData' ) );
	...
	public function filter_selected_organizer_id( $organizer_ids ) {
		...
		$submitted_ids = isset( $_POST['organizer']['OrganizerID'] )
			? (array) $_POST['organizer']['OrganizerID']
			: array();
